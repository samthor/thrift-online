...
function iconForType(type: ThriftType) {
  switch (type) {
...
export class AppNodeElement extends HTMLElement {
  ...
  #v: ParsedValue = { type: ThriftType.VOID, value: undefined };
  #render: () => void;
...
<main tabindex="0">
  ...
  <span id="value-holder"></span>
    ...
    mainEl.addEventListener('click', () => {
      this.dispatchEvent(new CustomEvent('choice', { composed: true, bubbles: true }));
    });
